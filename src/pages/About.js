        ...
        <div className="flex flex-col lg:flex-row h-full items-center justify-center gap-x-24 text-center lg:text-left lg:pt-16">
          ...
          >
            ...
            <p className="mb-12 max-w-xl sm:max-w-xl ">
              ...
              <br />
              <br />
              <b>TUNA</b> representa la creación de infinitos recuerdos de una
              ...
              <br />
              Ver fotos es una forma de viajar en el tiempo. Gracias a mi papas
              cada uno de mis hermanos tiene uno o dos albúm, cosa que
              agradezco. ¿Por qué? Porque todas esas fotos nos permiten ver
              emociones, cambios, personas que ya no estan, recordar momentos
              que tal vez si no estarian registradas no las recordariamos de esa
              forma. Por eso es tan lindo tener registros.
            </p>
