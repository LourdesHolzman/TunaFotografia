...
//import images
import Image1 from '../img/portfolio/DSC_0416.jpg';
import Image2 from '../img/portfolio/DSC_0091.jpg';
import Image3 from '../img/portfolio/DSC_0290-4.jpg';
import Image4 from '../img/portfolio/DSC_0212.jpg';
//import link
      ...
      <div className='container mx-auto h-full relative'>
        <div className='flex flex-col lg:flex-row h-full items-center justify-start gap-x-24 text-center lg:text-left pt-24 lg:pt-36 pb-8'>
          ...
          <motion.div
            ...
            <h1 className='h1 lg:mt-20'> INFANTIL </h1>
        ...
        className='text-[#696c6d] hover:text-primary trasition'>
          OTROS
            ...
            <p className='mb-12 mt-2 max-w-sm'>
              Estas sesiones se convierten en un juego. 
              <br/>
              Los chicos no van a hacer lo que queremos nosotros, sino lo que ellos quieran. 
              <br/>
              En esta sesión van <b>jugar, correr y divertirse</b>.
              <br/>
              Ellos lo viven como un juego, estan en su mundo, siendo chicos, divirtiéndose, explorando, jugando y yo solo los sigo con mi cámara.
