        ...
        <div className="flex flex-col lg:flex-row h-full items-center justify-start gap-x-24 text-center lg:text-left pt-24 lg:pt-36 pb-8">
          ...
          >
            ...
            <p className="mb-12 mt-2 max-w-sm">
              No hay mejor plan que pasar una tarde en la naturaleza en familia,
              ¿qué más se puede pedir? Estas sesiones están marcadas por la{" "}
              <b>naturalidad del momento</b>, pocos posados y muchas risas.
              <br />
              <br />
            </p>
            <NavLink to={"/contact"} className="btn mb-[30px] mx-auto lg:mx-0">
              Contactame
            </NavLink>
          </motion.div>
